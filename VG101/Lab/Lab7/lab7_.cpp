...
class MyGame : public Game {
    ...
    public:
        ...
        void initialize(int A_X,int A_Y,int B_X,int B_Y,Direction A_direction,Direction B_direction) override {
            ...
            border=0;
            bulletnum=0;
            for (int i=0;i<1000;++i) bullet[i].x=1000,bullet[i].y=1000;
            // Done!
        }
        ...
        Turn turn() override {
            ...
            //std::cout<<Round<<endl;
            //std::cout<<"A("<<Tank_A.x<<","<<Tank_A.y<<")"<<Tank_A.direction<<"\t";
            //std::cout<<"B("<<Tank_B.x<<","<<Tank_B.y<<")"<<Tank_B.direction<<endl;
            //std::cout<<"A:"<<Tank_A.life<<"-"<<"B:"<<Tank_B.life<<std::endl;
            // Done!
...
public:
    ...
    double distance()
    {
        //To get the distance between Tank A and Tank B
    }
